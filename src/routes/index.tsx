        ...
        {PACKAGES.map((p) => (
          ...
          >
            ...
            <a
              ...
              className={`mt-auto w-full rounded-2xl px-5 py-3 text-center text-sm font-semibold transition-colors ${
                p.featured
